...
<body>
   <h3 class="text-center mb-4">Hostel No 5:</h3>
    <h7> Select Your Room  from the following:  </h7>
    
    
        
 <form action="bh5update.php" method="post">
  ...
  <div class="row align-items-start">
    <div class="col">
      ...
      Ground Floor<br>
     <?php
      $sql="select * from bh5details where floor_no=1 and vacant_seats>0";
    ...
    <div class="col">
      First Floor<br>
      <?php
      $sql="select * from bh5details where floor_no=2 and vacant_seats>0";
      $result=mysqli_query($con,$sql);
       if(mysqli_num_rows($result)>0)
    {
        while($row=mysqli_fetch_array($result))
    ...
    <div class="col">
      ...
      <?php
      $sql="select * from bh5details where floor_no=3 and vacant_seats>0";
      $result=mysqli_query($con,$sql);
       if(mysqli_num_rows($result)>0)
    {
        while($row=mysqli_fetch_array($result))
  ...
  <div class="form-group">
      <label>Captcha Code</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="captchabh5.php" alt="PHP Captcha"><br><br>
<br><br<br>
