...
//$gender=$_SESSION['gender'];
 ...
 if(isset($_POST["submit"]))
 {
     ...
     $filled=1;
      ...
      $sql="Insert into student_data (name,application_id, father_name,branch,self_mobile,father_mobile,mother_name,mother_mobile,address,state,ph,gender,filled,hostel_no,local_guardian,email,smobile,blood_group) values ('$name','$regno','$father','$branch','$selfno','$fatherno','$mother','$motherno','$address','$state','$phandicap','$gender','$filled','$hostel_no','$lguardian','$email','$siblingmobile','$blood_group')";
         ...
         {  
             ...
             {
                 echo '<script type=\'text/javascript\'> alert("Your Information Has Been Saved Successfully"); location="bh1.php";</script>';
         ...
         
         {
             if(mysqli_query($con,$sql))
             {
                 echo '<script type=\'text/javascript\'> alert("Your Information Has Been Saved Successfully"); location="bh2.php";</script>';
         ...
         {  
             ...
             if(mysqli_query($con,$sql))
             {
                 echo '<script type=\'text/javascript\'> alert("Your Information Has Been Saved Successfully"); location="bh5.php";</script>';
     ...
     {
         echo '<script type=\'text/javascript\'> alert("Please fill the form again !"); location="form.php";</script>';
     }
