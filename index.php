...
<body><br>
    ...
    <br><br><br><br>
    <center>
        <h1>NITJ Hostel Allocation System</h1>
                ...
                <div class="col-md-6 offset-md-3 login-container">
                    ...
                    <form action="signupProcess.php" method="POST">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="appid" name="appid" pattern=[0-9]{12}
                                placeholder="Enter JEE(Main) Application ID" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="Day Scholar">Hostel Option</label>
                    ...
                    <center>If already registered, <a href="signin.php">Click Here</a> </center><br>
                    <center> Before starting the process please read the <a href="haprocess.pdf">hostel allocation
                            process document.</a></center>
                </div>
            </div>
        </div>
