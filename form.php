...
$bh1_sql="select sum(vacant_seats) from bh1details";
$bh2_sql="select sum(vacant_seats) from bh2details";
$bh5_sql="select sum(vacant_seats) from bh5details";

$result_bh1=mysqli_query($con,$bh1_sql);
$bh1_data=mysqli_fetch_array($result_bh1);

$result_bh2=mysqli_query($con,$bh2_sql);
$bh2_data=mysqli_fetch_array($result_bh2);

$result_bh5=mysqli_query($con,$bh5_sql);
$bh5_data=mysqli_fetch_array($result_bh5);


$bh1_vacant_sql="select sum(vacant_seats) from bh1details";
$bh2_vacant_sql="select sum(vacant_seats) from bh2details";
$bh5_vacant_sql="select sum(vacant_seats) from bh5details";
...
<div class="form-group">
    ...
    <select name="hostel_no" id="hostel_no"  class="form-control"  required>
        <option value="">Select</option>
        <?php if($bh1_data['sum(vacant_seats)']>0)
       { echo ' <option value="1">Hostel No 1</option>'; } ?> 
       <?php if($bh2_data['sum(vacant_seats)']>0)
       { echo ' <option value="2">Hostel No 2</option>'; } ?>
